...
public class SignupOne extends JFrame implements ActionListener{
	...
	long random;
	JTextField nameTextField,cityTextField,stateTextField,emailTextField,pincodeTextField,addressTextField,fnameTextField;
	JButton next;
    ...
    public void actionPerformed(ActionEvent ae) {
    	...
    	try {
    		if(name.equals("")) {
    			...
    			Conn c = new Conn();
    			String query = "insert into signupOne values('"+formn+"','"+name+"', '"+fname+"', '"+dob+"', '"+gender+"', '"+email+"', '"+marital+"', '"+address+"', '"+city+"', '"+pin+"', '"+state+"')";
    			c.stm.executeUpdate(query);

    			setVisible(false);
    			new SignupTwo(formn).setVisible(true);
    		}
    	}
    	catch(Exception e){
