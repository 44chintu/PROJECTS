...
def postLoginMenu():
    ...
    while True:
        ...
        if (choice == 'compose mail' or choice == "compose"):
            ...
            inbox()
        elif (choice == 'logout' or choice == 'log out'):
            logout()
            return
        elif (choice == 'quit' or choice == 'quite'):
            quitApp()
        else:
...
def login():
    ...
    emailId = 'vemulapallyjyotsna@gmail.com'
    password = 'ppdsqtlqlhhpekmz'
...
def initGUI():
    ...
    mailIcon = tkinter.PhotoImage(file='emailIcon.png')
    ...
    canvas.pack()
    micEnabledIcon = Image.open('micEnabledIcon.png')
    mic_image_off = 10
    ...
    micDisabledIcon = Image.open('micDisabledIcon.png')
